	...
	const carports = useSignal<Carport[]>([
		{
			...
			imagePath: "/images/carports/cp_standard.webp"
		},
		{
			id: "triple",
			name: "Triple Wide",
			...
			imagePath: "/images/carports/cp_triple.webp"
		},
		{
			id: "commerical",
			name: "Commerical",
			...
			imagePath: "/images/carports/cp_commercial.webp"
		},
		{
			id: "garage",
			name: "Garage",
			...
			imagePath: "/images/carports/cp_garage.webp"
		},
		{
			id: "rvcover",
			name: "RV Cover",
			...
			imagePath: "/images/carports/cp_rvcover.webp"
		},
		{
			id: "combo",
			name: "Combo Unit",
			...
			imagePath: "/images/carports/cp_combo.webp"
		},
		{
			id: "hosebarn",
			name: "Horse Barn",
			...
			imagePath: "/images/carports/cp_horsebarn.webp"
		},
		{
			id: "singlesloperoof",
			...
			imagePath: "/images/carports/cp_singlesloperoof.webp"
		},
		{
			id: "loafingshed",
			name: "Loafing Shed",
			...
			imagePath: "/images/carports/cp_loafingshed.webp"
		},
	])
		...
		<section class="p-2 sm:p-4 bg-white">
			...
			<div class="flex flex-col lg:flex-row gap-4">
				...
				<div class="flex flex-col gap-3 flex-1 min-w-0">
					...
					<div class="w-full">
						<img
                            src={selectedCarport.value?.imagePath || "/images/carports/cp_standard.webp"}
