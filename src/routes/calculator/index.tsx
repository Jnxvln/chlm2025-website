...
export default component$(() => {
  ...
  useVisibleTask$(({ track }) => {
    ...
    // Use consistent dark text color for labels
    const textColor = 'rgb(55, 65, 81)'; // gray-700
  ...
  return (
    <section class="px-4 sm:px-8 py-12 bg-gray-50 min-h-screen">
      <div class="max-w-7xl mx-auto">
        <h1 class="text-3xl sm:text-4xl font-bold text-gray-900 mb-2">Cubic Yards Estimator</h1>
        <p class="text-gray-600 mb-8">Estimate the amount of material you need for your project</p>
        ...
        <div class="bg-white p-6 rounded-lg shadow-md mb-6">
          ...
          <select
            class="w-full px-4 py-2 border border-gray-300 rounded-lg shadow-sm focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white text-gray-900"
            onChange$={(e) =>
        ...
        <section class="flex flex-col lg:flex-row gap-6">
          ...
          <div class="flex-1 flex justify-center items-center bg-white rounded-lg shadow-md p-6 border border-gray-200 min-h-[300px]">
            <canvas
              ref={canvasRef}
              width={400}
              height={300}
          ...
          <div class="flex-1">
            <div class="bg-white rounded-lg shadow-md p-6">
              <form class="space-y-4" preventdefault:submit onSubmit$={calculate}>
                {shapeChosen.value !== 'null' && (
                  <>
                    {shapeInputs[shapeChosen.value].map((field) => {
                      ...
                      return (
                        <div key={field.name} class="flex gap-2">
                          <div class="flex-1">
                            <label class={`block mb-2 text-sm font-medium ${labelClass}`}>
                              {field.label}
                            </label>
                            <input
                              type="number"
                          ...
                          <div class="w-24">
                            ...
                            <select
                              ...
                              class="w-full px-2 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 bg-white"
                            >
                    ...
                    <div>
                      <label class="block mb-2 text-sm font-medium text-gray-700">
                        Quantity (how many of these do you have?)
                      </label>
                      <input
                        type="number"
                        step="1"
              ...
              {result.value !== null && (() => {
                ...
                return (
                  <div class="mt-6 p-6 rounded-lg bg-green-50 border-2 border-green-500">
                    ...
                    <p class="text-xs mt-2 italic text-gray-500">
                      Minimum load: 1/4 yd (half a bucket full)
                    </p>
